...
class AjaxController(BaseController):
	...
	def P_channels(self, request):
		...
		if model in ("Solo²", "Duo²", "Sezam Marvel", "Xpeed LX-3", "Quad", "Quad Plus") and path.exists(eEnv.resolve('${libdir}/enigma2/python/Plugins/SystemPlugins/TransCodingSetup/plugin.pyo')):
