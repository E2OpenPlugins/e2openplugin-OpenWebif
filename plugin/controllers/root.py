...
class RootController(BaseController):
	...
	def P_index(self, request):
		...
		if uagent:
			if uagent.find("iPhone") != -1 or uagent.find("iPod") != -1 or uagent.find("iPad") != -1 or uagent.find("BlackBerry") != -1 or (uagent.lower().find("android") != -1 and uagent.lower().find("mobile") != -1):
