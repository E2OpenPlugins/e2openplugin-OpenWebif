...
def getAllInfo():
	...
	if fileExists("/proc/stb/info/hwmodel"):
		...
		if procmodel.startswith("et"):
			...
			model = "H10 Series"
			grabpip = 1
		elif procmodel == "h10combo":
			brand = "Zgemma"
			model = "H10 Combo"
			grabpip = 1
		elif procmodel == "h10twin":
			brand = "Zgemma"
			model = "H10 Twin"
			grabpip = 1
	...
	if procmodel in ("vusolo", "vuduo", "vuuno", "vusolo2", "vusolose", "vuzero", "vusolo4k", "vuuno4k", "vuultimo4k"):
		...
		remote = "sh1"
	elif procmodel in ("hzero", "h3", "h4", "h5", "h6", "h7", "h8", "h9", "h10", "i55plus", "h9.s", "h9.t", "h9.2s", "h9.2h", "h9combo", "h9twin", "h10combo", "h10twin"):
		remote = "h3"
	elif procmodel == "i55":
		remote = "i55"
