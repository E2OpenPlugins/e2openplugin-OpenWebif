	...
	var EPGR = function () {
		...
		return {
			...
			setup: function () {
				...
				$('#er_begin').val('22:30');
				$('#er_end').val('6:30');
				$("#bouquets").change( function() {$("#bouquets").val($(this).val()); self.er_bqchchanged = true;});
				$("#channels").change( function() {$("#channels").val($(this).val()); self.er_bqchchanged = true;});
